...
HELP_TOPICS = [
    ...
    ("sorters", "Sorters",
     ["A 'sorter' is the algorithm that detects neurons. tridesclous2 is the ★",
      "recommended default: fast, reliable, needs no GPU. Press t for the picker —",
      "sorters grouped by what your computer can run right now; type to filter."]),
    ("probe", "Probe geometry",
     ["The Blackrock files carry no electrode map, so you choose the geometry.",
      ...
      "Geometry decides which sorters fit — the fit note shows in the t picker.",
