...
HELP_TOPICS = [
    ...
    ("probe", "Probe geometry",
     ["The Blackrock files carry no electrode map, so you choose the geometry.",
      "Press p (or the 'Probe geometry' action) to pick a profile: a placeholder",
      "(independent channels), a standard layout, a Cui-lab preset, your own, or an",
      "imported probeinterface file (scripts/probes.py import).",
      "Geometry decides which sorters fit — the fit detail shows in INSPECTING.",
    ...
    ("keys", "Keyboard",
     ["↑/↓ or j/k move · ←/→ or Tab/Shift-Tab switch panes · Enter run/activate",
      "1-6 run a workflow action · e params · m manage sorters · p probe · c theme",
      "v verify · r reopen last result · x manage highlighted sorter · w expand download",
      "t switch sorter · d data files · f data folder · PgUp/PgDn scroll INSPECTING · ? help",
      "q or Ctrl-C quit  (Esc cancels a dialog, not the app)"]),
    ("about", "About",
